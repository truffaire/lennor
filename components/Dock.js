// Floating quick-contact dock (WhatsApp + back-to-top), driven by main.js.
export default function Dock() {
  return (
    <div className="dock" id="dock">
      <a
        href="https://wa.me/917760778886"
        target="_blank"
      ...
      <button type="button" id="toTop" aria-label="Back to top" title="Back to top">
